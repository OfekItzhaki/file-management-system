...
export class Client implements IClient {
  ...
  filesGET(
    ...
    if (tags === null) throw new globalThis.Error("The parameter 'tags' cannot be null.");
    else if (tags !== undefined)
      tags &&
        tags.forEach((item) => {
          url_ += 'tags=' + encodeURIComponent('' + item) + '&';
        });
    if (isPhoto === null) throw new globalThis.Error("The parameter 'isPhoto' cannot be null.");
    else if (isPhoto !== undefined) url_ += 'isPhoto=' + encodeURIComponent('' + isPhoto) + '&';
    if (folderId === null) throw new globalThis.Error("The parameter 'folderId' cannot be null.");
    else if (folderId !== undefined) url_ += 'folderId=' + encodeURIComponent('' + folderId) + '&';
    ...
    if (take === null) throw new globalThis.Error("The parameter 'take' cannot be null.");
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as SearchFilesResult);
        return result200;
      });
  ...
  upload(
    ...
    else content_.append('destinationFolderId', destinationFolderId.toString());
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as UploadFileResult);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as RenameFileResult);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as GetFoldersResult);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as CreateFolderResult);
        return result200;
      });
    } else if (status === 400) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as RenameFolderResult);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as DeleteFolderResult);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
